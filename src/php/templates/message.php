          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:5px 30px;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">¡Se ha reportado un nuevo fallo!</h1>
                <p style="margin:0;">Esta es la información recabada por el cliente:</p>
              </td>
            </tr>
            <table style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
                <tr style="margin: 0px 5px">
                    ...
                    <td class="tabla"><?php echo $fallo->getID(); ?></td>
                </tr>
                <tr style="margin: 0px 5px">
                    <th class="tabla">Descripción</th>
                    <td class="tabla"><?php echo $fallo->getDescripcion(); ?></td>
                </tr style="margin: 0px 5px">
                <tr>
                    <th class="tabla">Proyecto</th>
                    <td class="tabla"><?php echo $fallo->getProyecto()->getNombre(); ?></td>
                </tr style="margin: 0px 5px">
                <tr>
                    <th class="tabla">Fecha de incidencia</th>
                    <td class="tabla"><?php echo $fallo->getFecha(); ?></td>
                </tr style="margin: 0px 5px">
