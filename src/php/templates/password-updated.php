          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:5px 30px;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:24px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Se ha actualizado tu contraseña</h1>
                <p style="margin:0;">Ya puedes acceder al sistema con tu nueva contraseña </p>
              </td>
            </tr>
            <tr>
              <td style="padding:5px 30px;">
