...
$empleado = Empleado::fromJson($json);
          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:5px 30px;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:26px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Bienvenido a TI Support Manejo de Errorees</h1>
                <p style="margin:0;">Estos son los datos de su nueva cuenta</p>
              </td>
            </tr>
            <table style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
                <tr style="margin: 0px 5px">
                    ...
                    <td class="tabla"><?php echo $empleado->getCorreo(); ?></td>
                </tr>
                <tr style="margin: 0px 5px">
                    <th class="tabla">Nombre</th>
                    <td class="tabla"><?php echo $empleado->getNombre(); ?></td>
                </tr style="margin: 0px 5px">
                <tr>
                    <th class="tabla">Contraseña</th>
                    <td class="tabla"><?php echo $password; ?></td>
                </tr style="margin: 0px 5px">
                <tr>
            </table style="padding:5px 30px;">
            <tr>
              <td style="padding:5px 30px;">
              <p style="margin:0;">Ingrese <a href="http://192.168.0.4/recuperar-contraseña.html">aquí</a> para cambiar la contraseña.</p>
              </td>
            </tr>
            <tr>
                <td style="padding:5px 30px;">
