          ...
          <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
            ...
            <tr>
              <td style="padding:5px 30px;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:24px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;">Se le ha asignado un fallo</h1>
                <p style="margin:0;">El director le ha asignado el fallo con id: </p>
              </td>
            </tr>
            <tr>
              <td style="padding:5px 30px;">
                <h1 style="margin-top:0;margin-bottom:16px;font-size:24px;line-height:32px;font-weight:bold;letter-spacing:-0.02em;text-align: center;"><?php echo $id; ?></h1>
              </td>
            </tr>
            <table style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-size:16px;line-height:22px;color:#363636;">
              <tr>
                <td style="padding:5px 30px;">
                  <p style="margin:0;">Ingresa al sistema <a href="">aquí</a> para ver todos los detalles.</p>
                </td>
              </tr>
              <tr>
                <td style="padding:5px 30px;">
